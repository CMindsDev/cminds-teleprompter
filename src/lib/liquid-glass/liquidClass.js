/*
 * liquidClass.js — vendorizado desde LiquidClass
 * Fuente: https://github.com/KaliforniaGator/LiquidClass (LiquidClass/src/liquidClass.js)
 *
 * ⚠️ LICENCIA: el proyecto original se publica bajo GNU AGPL-3.0.
 * Ver `src/lib/liquid-glass/NOTICE.md` antes de distribuir o desplegar
 * este proyecto públicamente.
 *
 * Este archivo se mantiene SIN modificar respecto al original. Toda
 * adaptación al proyecto vive en `init.ts`, que es código propio.
 */
